...
public class AirQualityServiceTest extends ServiceTest implements RedisTestContainer {
  ...
  void RegionFailBackSuccessTest() {
    ...
    airQualityService.updateRegionAriQuality(createObservatoryResponse("설성면", "경기 이천시 설성면"));
  ...
  private ObservatoryResponse createObservatoryResponse(String stationName, String addr) {
