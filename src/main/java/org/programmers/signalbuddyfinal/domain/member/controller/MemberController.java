...
public class MemberController {
    ...
    public ResponseEntity<ApiResponse<Boolean>> verifyPassword(@PathVariable Long id, @RequestParam String password) {
    ...
    /**
     * ApiResponse 는 JSON 형태의 응답을 생성하는데 사용되므로 <br>
     * 이미지 파일을 직접 반환하기 위해 {@code ResponseEntity<Resource>}를 사용.
     *
     * @param id Member ID
     * @return Resource 객체
     */
